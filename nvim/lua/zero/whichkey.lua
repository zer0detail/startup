...
vim.opt.timeoutlen = 500 -- Set the timeout to 500 milliseconds
...
local mappings = {
  ...
  r = {
    ...
    c = {
      ...
      h = { "<cmd>lua require 'crates'.open_homepage()<cs>", "Open Crate Homepage" },
      ...
      i = { "<cmd>lua require 'crates'.open_crates_io()<cr>", "Open Crate.io" },
      p = { "<cmd>lua require 'crates'.show_popup()<cr>", "Show Crate Details Popup" },
    },
    ...
    s = { "<cmd>lua require('rust-tools').ssr.ssr(query)<cr>", "Structural Search and Replace" },
    g = { "<cmd>lua require('rust-tools').crate_graph.view_crate_graph(backend,output)<cr>", "Crate Graph" },
  }
}
